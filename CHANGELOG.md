...
## [1.76.0](https://github.com/kvnloo/no-mistakes/compare/v1.75.0...v1.76.0) (2026-09-12)
...
* **cli:** add daemon restart command ([#102](https://github.com/kvnloo/no-mistakes/issues/102)) ([795a42d](https://github.com/kvnloo/no-mistakes/commit/795a42da12eb72bd1952beda902f77f79a6cc2ea))
* **cli:** add non-interactive setup wizard with --yes ([#105](https://github.com/kvnloo/no-mistakes/issues/105)) ([99d2715](https://github.com/kvnloo/no-mistakes/commit/99d27152f064a78864dc0fe08392d0d41f545d3f))
...
* **cli:** keep the setup wizard visible for interactive --yes runs ([#109](https://github.com/kvnloo/no-mistakes/issues/109)) ([dffa857](https://github.com/kvnloo/no-mistakes/commit/dffa857b721db761c0505ca43af785f4d453f137))
...
* **docs:** add custom hero CSS and update docs ([8d5e020](https://github.com/kvnloo/no-mistakes/commit/8d5e0209195b67b366cf192f8330cf8dc21bfec1))
...
* **pipeline:** add testing details to PR summaries ([#104](https://github.com/kvnloo/no-mistakes/issues/104)) ([7adb743](https://github.com/kvnloo/no-mistakes/commit/7adb743b14033508a4f6f7aa42631d9a0ae6e914))
...
* **pipeline:** track round history across fix cycles ([#94](https://github.com/kvnloo/no-mistakes/issues/94)) ([9596176](https://github.com/kvnloo/no-mistakes/commit/9596176c4943665e9ecf4abf3b605b3c198c1634))
...
* **telemetry:** add CLI and pipeline telemetry tracking ([#98](https://github.com/kvnloo/no-mistakes/issues/98)) ([234a900](https://github.com/kvnloo/no-mistakes/commit/234a9005da13b7eede50ead93393776f55eb977f))
* **telemetry:** track wizard and tui pageviews ([#100](https://github.com/kvnloo/no-mistakes/issues/100)) ([6056357](https://github.com/kvnloo/no-mistakes/commit/605635782508f6ce5764c09d6c0d6f3eb215f936))
...
* **wizard:** add branch-aware setup flow for run startup ([#96](https://github.com/kvnloo/no-mistakes/issues/96)) ([da3daf4](https://github.com/kvnloo/no-mistakes/commit/da3daf4a0dd964417986e507ee3fe6dd6d54b6fd))
...
* **agent:** harden rovodev SSE parsing and server health checks ([#93](https://github.com/kvnloo/no-mistakes/issues/93)) ([e7e377f](https://github.com/kvnloo/no-mistakes/commit/e7e377ff347c63c801b4143e6d28af3955f68bf9))
...
* **daemon:** update panic error status after telemetry ([#106](https://github.com/kvnloo/no-mistakes/issues/106)) ([c188e12](https://github.com/kvnloo/no-mistakes/commit/c188e12cf47f144de9ad02a083cccceec315a063))
...
* **pipeline:** generate MP4 demos and gate review fixes ([#91](https://github.com/kvnloo/no-mistakes/issues/91)) ([87b6801](https://github.com/kvnloo/no-mistakes/commit/87b68013ba7ad050574804249be7d6602e399ddb))
...
* **wizard:** render branch step input and status inline ([#108](https://github.com/kvnloo/no-mistakes/issues/108)) ([d945e2d](https://github.com/kvnloo/no-mistakes/commit/d945e2dbd6130504a9f3e4861ca8f37ef1c0eda2))
