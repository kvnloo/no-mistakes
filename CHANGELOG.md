...
## [1.80.0](https://github.com/kvnloo/no-mistakes/compare/v1.79.0...v1.80.0) (2026-09-19)
...
* **agent:** support agent args override ([#133](https://github.com/kvnloo/no-mistakes/issues/133)) ([18c58ae](https://github.com/kvnloo/no-mistakes/commit/18c58aef526a7c2b887246e80c9455bbebe27811))
...
* **cli:** cache wizard commit subject from branch suggestions ([#117](https://github.com/kvnloo/no-mistakes/issues/117)) ([134fadb](https://github.com/kvnloo/no-mistakes/commit/134fadb3273e11835bcb43b6d8c8866a14d3575a))
...
* **tui:** add finding overrides for manual fix rounds ([#135](https://github.com/kvnloo/no-mistakes/issues/135)) ([4b62714](https://github.com/kvnloo/no-mistakes/commit/4b62714cb55be3a09fe1acd1da1532dea39d2583))
...
* **update:** add beta release channel ([#136](https://github.com/kvnloo/no-mistakes/issues/136)) ([907e6e3](https://github.com/kvnloo/no-mistakes/commit/907e6e33f44d843915e946b4b26689f6c91fa158))
* **wizard:** show setup progress in terminal title ([#116](https://github.com/kvnloo/no-mistakes/issues/116)) ([4d42a7a](https://github.com/kvnloo/no-mistakes/commit/4d42a7adabd63c888c1e970829be766897306530))
...
* **agent:** harden structured JSON fallback parsing ([#144](https://github.com/kvnloo/no-mistakes/issues/144)) ([21449db](https://github.com/kvnloo/no-mistakes/commit/21449dbdcffabe35bc6c34b4c39fdb6ba2a5fae4))
...
* **agent:** support Codex output schema parsing ([#141](https://github.com/kvnloo/no-mistakes/issues/141)) ([f4f253e](https://github.com/kvnloo/no-mistakes/commit/f4f253efdc3eeba34ad852d97f791ee7a034b060))
...
* **daemon:** clean up timed-out daemon startups safely ([#128](https://github.com/kvnloo/no-mistakes/issues/128)) ([b6a2389](https://github.com/kvnloo/no-mistakes/commit/b6a238921439347e377ed6ed46f4716e95830b6b))
...
* **daemon:** harden orphaned agent server recovery ([#121](https://github.com/kvnloo/no-mistakes/issues/121)) ([7600bb7](https://github.com/kvnloo/no-mistakes/commit/7600bb7de56772dd67c6e023c5deec2608d0572b))
...
* **daemon:** refresh managed services with stable PATH ([#148](https://github.com/kvnloo/no-mistakes/issues/148)) ([cac217f](https://github.com/kvnloo/no-mistakes/commit/cac217f6a931bd0afcde6379cc310bf995285464))
...
* **daemon:** retry busy launchctl bootstrap ([#150](https://github.com/kvnloo/no-mistakes/issues/150)) ([40412a8](https://github.com/kvnloo/no-mistakes/commit/40412a871bcff44802430b9d8406f1b67d945f1f))
* **daemon:** tighten detached fallback around managed service stop failures ([#115](https://github.com/kvnloo/no-mistakes/issues/115)) ([957065a](https://github.com/kvnloo/no-mistakes/commit/957065a3637cc0b971eadb8d651ecb95feebc76e))
...
* **git:** isolate gate hooks from shared hookspath changes ([#127](https://github.com/kvnloo/no-mistakes/issues/127)) ([a1d5bab](https://github.com/kvnloo/no-mistakes/commit/a1d5bab0631ae443d9a83943527613b743e95e3b))
* **git:** move core.bare into worktree config ([#130](https://github.com/kvnloo/no-mistakes/issues/130)) ([75f20a9](https://github.com/kvnloo/no-mistakes/commit/75f20a9027732ad121244a174f44f1a312b9f9d7))
...
* **pipeline:** harden CI autofix rerun retry guards ([#123](https://github.com/kvnloo/no-mistakes/issues/123)) ([ac8cb83](https://github.com/kvnloo/no-mistakes/commit/ac8cb8360e0dafb90ac1e0c9b13db041cc65d35f))
...
* **pipeline:** make CI auto-fix retry after reruns reliably ([#145](https://github.com/kvnloo/no-mistakes/issues/145)) ([e7320c7](https://github.com/kvnloo/no-mistakes/commit/e7320c70135df494daeb0fe61a41001de46f3e92))
...
* **release:** run publish jobs after skipped validation ([#113](https://github.com/kvnloo/no-mistakes/issues/113)) ([2fa5d24](https://github.com/kvnloo/no-mistakes/commit/2fa5d24850aa4bd1fd3b24693554257b32a9d2e5))
...
* **tui:** backfill rerun pipeline steps without stale placeholders ([#111](https://github.com/kvnloo/no-mistakes/issues/111)) ([ae4ae8b](https://github.com/kvnloo/no-mistakes/commit/ae4ae8b91cbc7c830a7ce05b5728887d56f6dc67))
...
* **wizard:** wait for daemon run before attach handoff ([#119](https://github.com/kvnloo/no-mistakes/issues/119)) ([ca47098](https://github.com/kvnloo/no-mistakes/commit/ca47098b34040a18765d95922eb3158052792f28))
